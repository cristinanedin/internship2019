...
public class CustomerSubscribePageTest extends TestBase {
    private final static String EXPECTED_PAY_MONTHLY_TEXT = "Pay monthly";
    private final static String EXPECTED_DAY_TRIAL_TEXT = "Free 30 day trial";
    private final static String EXPECTED_STANDARD_ACCESS_TEXT = "Standard Access";
    private final static String EXPECTED_PER_WEEK_TEXT = "£2 per week";
    private final static String EXPECTED_DIGITAL_ACCESS_TEXT = "All Digital Access";
    private final static String EXPECTED_PER_WEEK2_TEXT = "£3 per week";
